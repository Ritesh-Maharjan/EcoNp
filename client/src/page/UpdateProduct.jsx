...
import { getProduct, updateProduct } from "../utils/productApi";
...
const UpdateProduct = () => {
    ...
    const getProductApi = async () => {
      ...
      if (resData?.data?.success) {
        setData({
          ...
          desc: resData.data.product.description,
          category: resData.data.product.category,
          stock: resData.data.product.stock,
          discounted: resData.data.product.discounted,
          color: resData.data.product.color,
          size: resData.data.product.size,
          images: "",
        });
      }
    };
  ...
  const updateProductApi = async (e) => {
    ...
    if (!price || !desc || !category || !stock) {
      ...
      const resData = await updateProduct(id, formData, token);
